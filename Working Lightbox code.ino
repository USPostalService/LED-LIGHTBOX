...
#define __brightness_levels 28 // 0...15 above 28 is bad for ISR ( move to timer1, lower irq freq ! )
...
void loop(void) {
//set_led_blue(6,6,255);
//
//set_led_red(1,1,255);
//
//set_led_green(0,0,255);
//
//set_led_hue(2,2,200);
//
//set_led_hue(3,3,144);
...
for (counter1 = 0; counter1 <= 7; counter1++) {
  for (counter2 = 0; counter2 <= 7; counter2++) {
    ...
    delay(10);
    Serial.println(brightness_red[counter1][counter2]);
  }
}
